...
from app.admin.config import AdminRoleHierarchy, AdminLevel, is_super_admin_required, is_system_admin_required, get_admin_config
from app.admin.exceptions import (
    InsufficientPermissionsError, AdminOnlyError, SuperAdminOnlyError, 
    SystemAdminOnlyError, SelfModificationError
)
...
class AdminUser:
    ...
    def is_admin(self) -> bool:
        ...
        return AdminLevel.ADMIN in self.roles or self.is_super_admin or self.is_system_admin
