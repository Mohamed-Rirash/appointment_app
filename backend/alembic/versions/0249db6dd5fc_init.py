...
Revision ID: 0249db6dd5fc
Revises:
Create Date: 2025-09-06 13:57:23.669122
...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_permissions_active", "permissions", ["is_active"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_office_memberships_office_id"),
        "office_memberships",
        ["office_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_office_memberships_user_id"),
        "office_memberships",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_rbac_audit_created_at", "rbac_audit_log", ["created_at"], unique=False
    )
    op.create_index(
        "idx_rbac_audit_performed_by", "rbac_audit_log", ["performed_by"], unique=False
    )
    op.create_index(
        "idx_rbac_audit_resource",
        "rbac_audit_log",
    ...
    op.create_index(
        "idx_user_roles_expires", "user_roles", ["expires_at"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_office_memberships_user_id"), table_name="office_memberships"
    )
    op.drop_index(
        op.f("ix_office_memberships_office_id"), table_name="office_memberships"
    )
