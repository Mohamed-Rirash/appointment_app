(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__c8fb778a._.js",
...
"[project]/helpers/api/client.ts [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$helpers$2f$api$2f$client$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/helpers/api/client.ts [middleware-edge] (ecmascript)");
;
;
;
...
const { handlers, signIn, signOut, auth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$2d$auth$40$5$2e$0$2e$0$2d$beta$2e$29_nex_f99e20e4a2bd4718e07082f16c8f675b$2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])({
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$auth$2b$core$40$0$2e$40$2e$0$2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"])({
            async authorize (credentials) {
                ...
                try {
                    ...
                    const data = await __TURBOPACK__imported__module__$5b$project$5d2f$helpers$2f$api$2f$client$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["client"].Login(email, password);
                    // Fetch user profile with access_token
                    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$helpers$2f$api$2f$client$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["client"].GetUser(data.access_token);
    ...
    callbacks: {
        ...
        async jwt ({ token, user }) {
            ...
            // signOut();
            // Otherwise refresh
            const refreshed = await __TURBOPACK__imported__module__$5b$project$5d2f$helpers$2f$api$2f$client$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["client"].refreshAccessToken();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c8fb778a._.js.map