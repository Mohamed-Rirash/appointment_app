...
// Validate ../../app/(auth)/forget-password/page.tsx
{
  const handler = {} as typeof import("../../app/(auth)/forget-password/page.js")
  handler satisfies AppPageConfig<"/forget-password">
}
